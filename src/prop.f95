...
contains
  ...
  subroutine p676_dry(f, p, rho, T, g0)

    ! Specific attenuation for dry air.
    ! Equation numbers from ITU-R P.676-11.

    real, intent(in) :: f     ! frequency (GHz)
    real, intent(in) :: p     ! Dry air pressure (hPa)
    real, intent(in) :: rho   ! Water vapor density (g/m³)
    real, intent(in) :: T     ! Temperature (K)
    real, intent(out) :: g0   ! γ0 (dB/km)
    ...
    g0 = 0.182 * f * (sum(si * ffi) + ndf)                        ! (1-2)

  end subroutine p676_dry

  subroutine p676_vapor(f, p, rho, T, gw)

    ! Specific attenuation for water vapor.
    ! Equation numbers from ITU-R P.676-11.
    ...
    gw = 0.182 * f * (sum(si * ffi))                              ! (1-2)

  end subroutine p676_vapor
